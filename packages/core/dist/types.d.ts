...
export type FilterSpec = SelectFilterSpec | MultiSelectFilterSpec | DateRangeFilterSpec | SearchFilterSpec | NumericRangeFilterSpec;
...
export declare const WIDGET_SIZE_CONSTRAINTS: {
    readonly table: {
...
export type WidgetSpec = TableWidgetSpec | BarChartWidgetSpec | LineChartWidgetSpec | StackedBarChartWidgetSpec | KpiWidgetSpec;
export declare function getWidgetSizeConstraints(type: WidgetSpec["type"]): WidgetSizeConstraints;
