...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-3A5QY42A.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-5GOJXAGD.js"), act = await getAct();
...
//# sourceMappingURL=chunk-BZC2QJPR.js.map
